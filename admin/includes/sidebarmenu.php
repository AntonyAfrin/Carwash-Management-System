<div class="sidebar-menu">
	...
	<li><a href="add-booking.php"><i class="fa fa-user" aria-hidden="true"></i>  <span>Car Wash Booking</span><div class="clearfix"></div></a></li>
		 ...
		 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Page</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
