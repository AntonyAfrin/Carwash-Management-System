                    ...
                    <div class="col-lg-6">
                       ...
                       <div class="section-header text-center">
                        ...
                        <div class="about-content">
                            <p>
                                We are provide affortadable car washing and cleaning services.
                            </p>
                            <ul>
                                <li># Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Rs.250)</option>
                 <option value="2">PREMIUM CLEANING (Rs.350)</option>
                  <option value="3 ">COMPLEX CLEANING(Rs.500)</option>
              </select>
