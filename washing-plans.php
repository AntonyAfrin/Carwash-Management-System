                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs</span><strong>350</strong></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs.</span><strong>700</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Rs.350)</option>
                 <option value="2">PREMIUM CLEANING (Rs.500)</option>
                  <option value="3 ">COMPLEX CLEANING(Rs.700)</option>
              </select>
